            ...
            <div className="flex flex-col gap-1 md:flex-row md:items-start md:justify-between">
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Upload only after unbiased discovery is complete. This does not change Temporal PTM Trajectory Clustering or directionality; it evaluates the uploaded condition against existing source-precedes-target candidates.
                </p>
              </div>
