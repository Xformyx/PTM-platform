                ...
                {reportType === "co_scientist" && (
                  <div className="rounded-md border border-blue-500/30 bg-blue-500/10 p-2.5 text-[10px] text-blue-300 space-y-1">
                    ...
                    <ul className="list-disc list-inside space-y-0.5 text-blue-300/80">
                      <li>Temporal Profile Clustering — complete-case quantitative phosphorylation-feature profile의 구조적 군집화</li>
                      <li>Interval-wise Concordance Analysis — 고정 cluster 내 endpoint activity-state concordance annotation</li>
