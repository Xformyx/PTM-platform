...
export const LANGGRAPH_NODES = [
  ...
  { id: 6, name: "network_analysis", range: "55% - 65%", file: "nodes/network_node.py", desc: "PTM 데이터를 기반으로 단백질 상호작용 네트워크를 구축하고, Cytoscape Desktop의 CyREST API를 통해 시각화합니다.", state: "network_analysis, network_results" },
