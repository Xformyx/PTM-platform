...
export const LANGGRAPH_NODES = [
  ...
  { id: 6, name: "network_analysis", range: "55% - 65%", file: "nodes/network_node.py", desc: "PTM 데이터를 기반으로 단백질 상호작용 네트워크를 구축하고, Cytoscape Desktop의 CyREST API를 통해 시각화합니다. v5.0: PTM 노드는 Red/Blue 그라디언트, Non-PTM 노드는 Green/Purple/Gray 그라디언트(Protein_Log2FC 기반), Kinase 노드는 Amber 그라디언트로 색상 매핑. KEA3 + kinase_prediction(LLM) + kinase_substrate(패턴매칭) 3가지 소스에서 Kinase 노드 확장.", state: "network_analysis, network_results" },
